...
mpts = find_matching_points(start, end, masks, 100, 100, 100, 1.7)

savedir = '/home/chandoki/projects/def-mzhen/chandoki/rough_alignment/'
np.save(savedir + 'mpts.npy', mpts)
